...
local Window = Fluent:CreateWindow({Title = "HNC Hub",SubTitle = "By HNC Roblox",TabWidth = 120,Size = UDim2.fromOffset(455, 320),Acrylic = false,Theme = "Darker",MinimizeKey = Enum.KeyCode.End})
local Tabs = {
